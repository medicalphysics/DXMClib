    ...
    double minEnergy, double maxEnergy)
{
    ...
    m_energyResolution = static_cast<std::size_t>(std::ceil(
                             (m_maxEnergy - m_minEnergy) / m_energyStep))
        + 1;
...
double AttenuationLut::attenuationDataFromTypeNumber(std::size_t materialIdx,
    double energy) const
{
...
double AttenuationLut::totalAttenuation(std::size_t material,
    double energy) const
{
    return attenuationDataFromTypeNumber<0>(material, energy);
}
double AttenuationLut::rayleightAttenuation(std::size_t material,
    double energy) const
{
    return attenuationDataFromTypeNumber<3>(material, energy);
}
double AttenuationLut::photoelectricAttenuation(std::size_t material,
    double energy) const
{
    return attenuationDataFromTypeNumber<1>(material, energy);
}
double AttenuationLut::comptonAttenuation(std::size_t material,
    double energy) const
{
...
std::array<double, 3>
AttenuationLut::photoComptRayAttenuation(std::size_t material,
    double energy) const
{
...
double AttenuationLut::momentumTransfer(std::size_t material,
...
double AttenuationLut::cumFormFactorSquared(std::size_t material,
...
double AttenuationLut::comptonScatterFactor(std::size_t material,
    double momentumTransfer) const
{
...
std::vector<double> trapz(const std::vector<double>& f,
