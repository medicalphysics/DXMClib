...
public:
    ...
    void setCtdiVol(double ctdivol)
    {
        if (ctdivol > 0.0)
            m_ctdivol = ctdivol;
    }
...
public:
    ...
    void setTubeAmas(double mas)
    {
        m_specterValid = false;
        m_tubeAmas = std::max(0.0, mas);
    }
    void setTubeBmas(double mas)
    {
        m_specterValid = false;
        m_tubeBmas = std::max(0.0, mas);
    }
    ...
    void setSourceDetectorDistanceB(double sdd)
    {
        m_specterValid = false;
        m_sddB = std::abs(sdd);
    }
